...
@InputType()
class OcorrenciaUpdateManyWithoutAlunosInput {
  ...
  disconnect?: Array<OcorrenciaWhereUniqueInput>;
  ...
  set?: Array<OcorrenciaWhereUniqueInput>;
}
export { OcorrenciaUpdateManyWithoutAlunosInput };
